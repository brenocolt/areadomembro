...
export async function POST(req: NextRequest) {
  try {
    ...
    // recente disponível) e calcula a média por colaborador. Soma o
    // avaliacoes_nps de sempre com as respostas de formulários genéricos
    // marcados como fonte do NPS Projetos (mesmo formato de linha — ver
    // src/lib/nps-projetos-generico.ts) antes de agrupar, então o resto do
    // cálculo abaixo não muda nada.
